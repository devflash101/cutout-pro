  ...
  return (
    <Router>
      <Routes>
        ...
        <Route path='features' element={<CardPageLayout />}>
          ...
          <Route path='photo-color-correction' element={<PhotoColorCorrection />} />
          ...
          <Route path='background-diffusion' element={<BackgroundDiffusion />} />
